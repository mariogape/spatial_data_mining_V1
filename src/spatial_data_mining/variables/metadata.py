VARIABLE_METADATA = {
    ...
    "rgb": {
        ...
        "notes": "Closest image to rgb_date (OPENEO_RGB_DATE / rgb_date) within search window; defaults to mid-season date when not provided.",
        "temporal_coverage": {"start_year": 2017, "end_year": "present"},
        "temporal_resolution": "5_day",
        "season_options": ["winter", "spring", "summer", "autumn", "annual", "static"],
    },
    "swi": {
